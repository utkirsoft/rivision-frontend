              ...
              <el-tabs v-model="activeName" @tab-click="handleClick">
                ...
                <el-tab-pane label="Файллар" name="forth">
                  <el-row :gutter="40">
                    ...
                    <el-col :span="12">
                      <el-form-item label="Асослантирувчи ҳужжат тақдим этилган">
                        <el-upload
                          class="upload-demo"
                          action=""
                          :on-change="handleFileJustifyChange"
                          :on-preview="handleFileJustifyPreview"
                          :file-list="editOrderData.fileJustify"
                          accept=".pdf"
                          :auto-upload="false"
                        >
                          <el-button size="mini" type="primary" style="width: 100%">Юклаш</el-button>
                    ...
                    <el-col :span="12">
                      <el-form-item label="Қўзғатилган жиноят иши">
                        <el-upload
                          class="upload-demo"
                          action=""
                          :on-change="handleFileCriminalChange"
                          :on-preview="handleFileCriminalPreview"
                          :file-list="editOrderData.fileCriminal"
                          accept=".pdf"
                          :auto-upload="false"
                        >
                          <el-button size="mini" type="primary" style="width: 100%">Юклаш</el-button>
                    ...
                    <el-col :span="12">
                      <el-form-item label="Юритилган маъмурий иш">
                        <el-upload
                          class="upload-demo"
                          action=""
                          :on-change="handleFileAdministrativeChange"
                          :on-preview="handleFileAdministrativePreview"
                          :file-list="editOrderData.fileAdministrative"
                          accept=".pdf"
                          :auto-upload="false"
                        >
                          <el-button size="mini" type="primary" style="width: 100%">Юклаш</el-button>
                    ...
                    <el-col :span="12">
                      <el-form-item label="Жиноят ишини қўзғатишни рад қилинган">
                        <el-upload
                          class="upload-demo"
                          action=""
                          :on-change="handleFileRejectedChange"
                          :on-preview="handleFileRejectedPreview"
                          :file-list="editOrderData.fileRejected"
                          accept=".pdf"
                          :auto-upload="false"
                        >
                          <el-button size="mini" type="primary" style="width: 100%">Юклаш</el-button>
                    ...
                    <el-col :span="12">
                      <el-form-item label="Мавжуд жиноят ишига қўшиш учун юборилган хабарнома">
                        <el-upload
                          class="upload-demo"
                          action=""
                          :on-change="handleFileToCriminalChange"
                          :on-preview="handleFileToCriminalPreview"
                          :file-list="editOrderData.fileToCriminal"
                          accept=".pdf"
                          :auto-upload="false"
                        >
                          <el-button size="mini" type="primary" style="width: 100%">Юклаш</el-button>
                    ...
                    <el-col :span="12">
                      <el-form-item label="Бошқа ҳудудга юборилган хабарнома">
                        <el-upload
                          class="upload-demo"
                          action=""
                          :on-change="handleFileToRegionChange"
                          :on-preview="handleFileToRegionPreview"
                          :file-list="editOrderData.fileToRegion"
                          accept=".pdf"
                          :auto-upload="false"
                        >
                          <el-button size="mini" type="primary" style="width: 100%">Юклаш</el-button>
                    ...
                    <el-col :span="12">
                      <el-form-item label="Солиқ органларига қайта юборилган хабарнома">
                        <el-upload
                          class="upload-demo"
                          action=""
                          :on-change="handleFileToTaxChange"
                          :on-preview="handleFileToTaxPreview"
                          :file-list="editOrderData.fileToTax"
                          accept=".pdf"
                          :auto-upload="false"
                        >
                          <el-button size="mini" type="primary" style="width: 100%">Юклаш</el-button>
                    ...
                    <el-col :span="12">
                      <el-form-item label="Жиноят иши бўйича текшириш (тафтиш) якунланган">
                        <el-upload
                          class="upload-demo"
                          action=""
                          :on-change="handleFileCheckEndChange"
                          :on-preview="handleFileCheckEndPreview"
                          :file-list="editOrderData.fileCheckEnd"
                          accept=".pdf"
                          :auto-upload="false"
                        >
                          <el-button size="mini" type="primary" style="width: 100%">Юклаш</el-button>
                    ...
                    <el-col :span="12">
                      <el-form-item label="Ҳукумат ва бошқа орган қарорларига асосан ҳисобдан чиқарилган солиқ ва бошқа мажбурий тўловлар ҳамда қўлланилган молиявий жарималар">
                        <el-upload
                          class="upload-demo"
                          action=""
                          :on-change="handleFileFineSumChange"
                          :on-preview="handleFileFineSumPreview"
                          :file-list="editOrderData.fileFineSum"
                          accept=".pdf"
                          :auto-upload="false"
                        >
                          <el-button size="mini" type="primary" style="width: 100%">Юклаш</el-button>
